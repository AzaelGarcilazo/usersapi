...
public class JwtService {
    ...
    // ✅ MÉTODO CORREGIDO: Genera token CON el claim "role"
    public String generateToken(UserDetails userDetails) {
        Map<String, Object> extraClaims = new HashMap<>();

        // ✅ CRÍTICO: Agregar el rol al token
        if (userDetails instanceof Credential) {
            ...
            if (credential.getUser() != null && credential.getUser().getRole() != null) {
                ...
                System.out.println("🔐 Generando token para usuario: " + credential.getUser().getEmail());
                System.out.println("🔐 Rol agregado al token: " + roleName);
            } else {
                System.err.println("⚠️ WARNING: User o Role es NULL al generar token");
            }
        }
    ...
    private String buildToken(
        ...
        return Jwts
                .builder()
                .setClaims(extraClaims)  // ✅ Aquí se incluyen los extraClaims (role)
